...
const getStyles = createThemedStyles((colors) => ({
  ...
  templateCard: { backgroundColor: colors.surface,borderRadius: SIZES.radiusMd, padding: SIZES.md, marginRight: SIZES.sm, width: 200, borderWidth: 1, borderColor: colors.border },
  ...
  addTemplateCard: { backgroundColor: colors.surface,borderRadius: SIZES.radiusMd, padding: SIZES.md, width: 100, borderWidth: 1, borderColor: colors.border, borderStyle: 'dashed', alignItems: 'center', justifyContent: 'center' },
  addTemplateText: { fontSize: SIZES.fontXs, marginTop: SIZES.xs },
  filterContainer: { marginBottom: SIZES.md },
  filterButton: { paddingHorizontal: SIZES.md, paddingVertical: SIZES.sm, borderRadius: SIZES.radiusFull, backgroundColor: colors.surface,marginRight: SIZES.sm, borderWidth: 1, borderColor: colors.border },
  ...
  modalHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: SIZES.md, borderBottomWidth: 1, borderBottomColor: colors.border, backgroundColor: colors.surface},
  modalTitle: { fontSize: SIZES.fontLg, fontWeight: '600', color: colors.text },
  modalContent: { flex: 1, padding: SIZES.md },
  modalFooter: { padding: SIZES.md, borderTopWidth: 1, borderTopColor: colors.border, backgroundColor: colors.surface},
