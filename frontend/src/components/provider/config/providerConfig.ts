...
export const MIDWIFE_CONFIG: ProviderConfig = {
  ...
  dashboard: {
    ...
    quickActions: [
      ...
      { label: 'Appointments', icon: 'calendar', route: '/(midwife)/appointments', colorKey: 'warning' },
    ],
...
export const LACTATION_CONFIG: ProviderConfig = {
  ...
  clientDetailTabs: [
    ...
    { key: 'appointments', label: 'Appointments', icon: 'calendar' },
    { key: 'notes', label: 'Notes', icon: 'document-text' },
    { key: 'latch', label: 'LATCH', icon: 'water' },
    { key: 'feeding', label: 'Feeding', icon: 'droplets' },
    { key: 'weight', label: 'Weight', icon: 'bar-chart' },
    { key: 'oral', label: 'Oral Exam', icon: 'smile-plus' },
    { key: 'soap', label: 'SOAP', icon: 'document-text' },
    { key: 'messages', label: 'Messages', icon: 'chatbubbles' },
    { key: 'contracts', label: 'Contracts', icon: 'document' },
    { key: 'invoices', label: 'Invoices', icon: 'cash' },
    { key: 'birthplan', label: 'Birth Plan', icon: 'clipboard' },
