...
const styles = StyleSheet.create({
  ...
  filterContainer: { flexDirection: 'row', borderRadius: 18, padding: 4, marginBottom: SIZES.md },
  ...
  sectionTitle: { fontSize: SIZES.fontLg, fontFamily: F.serifSemi, marginBottom: SIZES.md, marginTop: SIZES.md },
  ...
  requestName: { fontSize: SIZES.fontMd, fontFamily: F.uiBold },
  requestSubtext: { fontSize: SIZES.fontSm, fontFamily: F.ui, marginTop: 2 },
  requestDate: { fontSize: SIZES.fontXs, fontFamily: F.ui, marginTop: 4 },
  ...
  requestDetailText: { fontSize: SIZES.fontXs, fontFamily: F.ui },
  requestPreviousExp: { fontSize: SIZES.fontXs, fontFamily: F.ui, fontStyle: 'italic', marginTop: SIZES.xs },
  requestCompletionRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: SIZES.xs },
  requestCompletionLabel: { fontSize: SIZES.fontXs, fontFamily: F.ui },
  requestCompletionBadge: { paddingHorizontal: SIZES.sm, paddingVertical: 2, borderRadius: SIZES.radiusFull },
  requestCompletionText: { fontSize: SIZES.fontXs, fontFamily: F.ui },
  ...
  actionText: { fontSize: SIZES.fontXs, fontFamily: F.ui, marginLeft: 4 },
  
  emptyCard: { alignItems: 'center', paddingVertical: SIZES.xl },
  emptyText: { fontSize: SIZES.fontLg, fontFamily: F.uiBold, marginTop: SIZES.md },
  emptySubtext: { fontSize: SIZES.fontSm, fontFamily: F.ui, textAlign: 'center', paddingHorizontal: SIZES.lg, marginTop: SIZES.xs },
  
  modalContainer: { flex: 1 },
  modalHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: SIZES.md, borderBottomWidth: 1 },
  modalTitle: { fontSize: SIZES.fontLg, fontFamily: F.serifSemi },
  ...
  modalName: { fontSize: SIZES.fontXl, fontFamily: F.serif },
  modalEmail: { fontSize: SIZES.fontMd, fontFamily: F.ui, marginTop: 4 },
  ...
  modalInfoLabel: { fontSize: SIZES.fontXs, fontFamily: F.ui },
  modalInfoValue: { fontSize: SIZES.fontMd, fontFamily: F.ui },
  modalDescription: { fontSize: SIZES.fontMd, fontFamily: F.ui, lineHeight: 22 },
