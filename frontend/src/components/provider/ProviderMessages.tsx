...
const getStyles = createThemedStyles((colors) => ({
  ...
  messageInput: { flex: 1, borderRadius: 18, paddingHorizontal: SIZES.md, paddingVertical: SIZES.sm, fontSize: SIZES.fontMd, maxHeight: 100, marginRight: SIZES.sm },
  ...
  clientSelectItem: { flexDirection: 'row', alignItems: 'center', padding: SIZES.md, borderRadius: 18, borderWidth: 1 },
  ...
  newMessageInput: { borderRadius: 18, padding: SIZES.md, fontSize: SIZES.fontMd, borderWidth: 1, minHeight: 100, textAlignVertical: 'top' },
  newMessageFooter: { padding: SIZES.md, borderTopWidth: 1 },
  startConversationButton: { borderRadius: 18, padding: SIZES.md, alignItems: 'center', justifyContent: 'center' },
