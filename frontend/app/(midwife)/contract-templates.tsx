...
export default function MidwifeContractTemplatesScreen() {
  ...
  const [plannedBirthLocation, setPlannedBirthLocation] = useState('');
  ...
  const openEditModal = (template: ContractTemplate) => {
    ...
    setPlannedBirthLocation(template.template_data.planned_birth_location || '');
    setScopeDescription(template.template_data.scope_description || '');
  ...
  const handleSave = async () => {
    ...
    try {
      const payload = {
        ...
        planned_birth_location: plannedBirthLocation.trim() || null,
        ...
        {templates.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>
              Create reusable templates to quickly generate midwifery contracts with pre-filled terms and fees.
            </Text>
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalBody} showsVerticalScrollIndicator={false}>
              ...
              <TextInput
                ...
                placeholder="e.g., Standard Midwifery Package"
              />
              ...
              <TextInput
                style={styles.input}
                value={plannedBirthLocation}
                onChangeText={setPlannedBirthLocation}
                placeholder="e.g., Home birth, Birth center"
              />

              <Text style={styles.inputLabel}>Scope of Services</Text>
              <TextInput
                style={[styles.input, styles.multilineInput]}
