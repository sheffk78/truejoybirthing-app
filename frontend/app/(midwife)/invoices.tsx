...
export default function MidwifeInvoicesScreen() {
  ...
  const fetchData = async () => {
    try {
      const [invoicesData, clientsData, templatesData] = await Promise.all([
        apiRequest(API_ENDPOINTS.MIDWIFE_INVOICES),
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              await apiRequest(`${API_ENDPOINTS.MIDWIFE_INVOICES}/${invoiceId}/send`, {
                method: 'POST',
              });
              await fetchData();
  ...
  const handleMarkPaid = async (invoiceId: string) => {
    try {
      await apiRequest(`${API_ENDPOINTS.MIDWIFE_INVOICES}/${invoiceId}/mark-paid`, {
        method: 'POST',
      });
      await fetchData();
    ...
    Alert.alert(
      ...
      [
        { text: 'No', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              await apiRequest(`${API_ENDPOINTS.MIDWIFE_INVOICES}/${invoiceId}/cancel`, {
                method: 'POST',
              });
              await fetchData();
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              await apiRequest(`${API_ENDPOINTS.MIDWIFE_INVOICES}/${invoiceId}/send-reminder`, {
                method: 'POST',
              });
              await fetchData();
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              await apiRequest(`${API_ENDPOINTS.MIDWIFE_INVOICES}/${invoiceId}`, {
                method: 'DELETE',
              });
              await fetchData();
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerButtons}>
            ...
            <TouchableOpacity style={styles.addButton} onPress={openCreateInvoice}>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalBody}>
              ...
              <TextInput
                style={styles.input}
                placeholder="e.g., Midwifery Services - Deposit"
...
const styles = StyleSheet.create({
  ...
  settingsButton: { width: 44, height: 44, borderRadius: 22, backgroundColor: COLORS.secondary + '20', alignItems: 'center', justifyContent: 'center' },
  addButton: { width: 44, height: 44, borderRadius: 22, backgroundColor: COLORS.secondary, alignItems: 'center', justifyContent: 'center' },
  ...
  defaultBadge: { backgroundColor: COLORS.secondary + '20', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 },
  defaultBadgeText: { fontSize: 10, color: COLORS.secondary, fontWeight: '600' },
  templatePreview: { fontSize: 12, color: COLORS.textSecondary, lineHeight: 16 },
  addTemplateCard: { width: 100, backgroundColor: COLORS.secondary + '10', borderRadius: 12, padding: SIZES.md, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: COLORS.secondary + '30', borderStyle: 'dashed' },
  addTemplateText: { fontSize: 12, color: COLORS.secondary, marginTop: 4 },
  ...
  invoiceInfo: { flex: 1 },
  invoiceNumber: { fontSize: 12, fontWeight: '600', color: COLORS.secondary, marginBottom: 2 },
  ...
  actionButton: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 6, backgroundColor: COLORS.secondary + '10', gap: 4 },
  ...
  clientOption: { paddingHorizontal: SIZES.md, paddingVertical: SIZES.sm, borderRadius: 20, backgroundColor: '#fff', borderWidth: 1, borderColor: COLORS.border, marginRight: SIZES.sm },
  clientOptionSelected: { backgroundColor: COLORS.secondary, borderColor: COLORS.secondary },
  clientOptionText: { fontSize: 14, color: COLORS.textPrimary },
  clientOptionTextSelected: { color: '#fff', fontWeight: '600' },
  templatePicker: { marginBottom: SIZES.xs },
  templatePickerItem: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16, backgroundColor: COLORS.secondary + '10', marginRight: 8 },
  templatePickerText: { fontSize: 12, color: COLORS.secondary },
  ...
  saveButton: { backgroundColor: COLORS.secondary, borderRadius: 8, padding: SIZES.md, alignItems: 'center' },
