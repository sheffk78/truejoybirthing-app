...
export default function MidwifeMessagesScreen() {
  ...
  const getRoleColor = (role: string) => {
    return role === 'MOM' ? COLORS.primary : role === 'DOULA' ? COLORS.roleDoula : COLORS.roleMidwife;
  };
  
  return (
    <SafeAreaView style={styles.container} edges={['top']} data-testid="midwife-messages-screen">
      <ScrollView
...
const styles = StyleSheet.create({
  ...
  unreadCard: {
    borderLeftWidth: 3,
    borderLeftColor: COLORS.roleMidwife,
  },
  conversationRow: {
    flexDirection: 'row',
    alignItems: 'center',
