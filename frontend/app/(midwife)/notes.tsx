...
export default function MidwifeNotesScreen() {
  ...
  const fetchData = async () => {
    try {
      const [notesData, clientsData] = await Promise.all([
        apiRequest(API_ENDPOINTS.MIDWIFE_NOTES),
  ...
  const handleCreateNote = async () => {
    ...
    setSaving(true);
    try {
      await apiRequest(API_ENDPOINTS.MIDWIFE_NOTES, {
        method: 'POST',
        body: {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']} data-testid="midwife-notes-screen">
      <ScrollView
        ...
        <SafeAreaView style={styles.modalContainer}>
          ...
          <ScrollView style={styles.modalContent}>
            ...
            <TextInput
              ...
              placeholder="Enter your clinical notes about this client..."
              placeholderTextColor={COLORS.textLight}
              multiline
              numberOfLines={6}
