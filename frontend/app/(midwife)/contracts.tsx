              ...
              {currentSection === 0 && templates.length > 0 && (
                <View style={styles.fieldContainer}>
                  ...
                  <View style={styles.templateGrid}>
                    ...
                    >
                      <Ionicons name="document-outline" size={16} color={selectedTemplateId === '' ? COLORS.secondary : COLORS.textSecondary} />
                      <Text style={[
                    ...
                    {templates.map((template) => (
                      ...
                      >
                        <Ionicons name="copy-outline" size={16} color={selectedTemplateId === template.template_id ? COLORS.secondary : COLORS.textSecondary} />
                        <Text style={[
                          styles.templateOptionText,
...
const styles = StyleSheet.create({
  ...
  templateOptionTextSelected: { color: COLORS.secondary, fontWeight: '600' },
  defaultLabel: {
  ...
  defaultLabelText: { fontSize: 10, fontWeight: '600', color: COLORS.secondary },
  clientGrid: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 8,
