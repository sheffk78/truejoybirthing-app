...
```bash
# Test auth endpoint
curl -X GET "https://pregnancy-timeline-1.preview.emergentagent.com/api/auth/me" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test protected endpoints
curl -X GET "https://pregnancy-timeline-1.preview.emergentagent.com/api/users/profile" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"
```
...
await page.goto("https://pregnancy-timeline-1.preview.emergentagent.com");
```
