...
```bash
# Test auth endpoint
curl -X GET "https://joy-birthing-fix.preview.emergentagent.com/api/auth/me" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test protected endpoints
curl -X GET "https://joy-birthing-fix.preview.emergentagent.com/api/users/profile" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"
```
...
await page.goto("https://joy-birthing-fix.preview.emergentagent.com");
```
