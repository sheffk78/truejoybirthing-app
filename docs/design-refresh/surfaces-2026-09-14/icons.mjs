...
const GLYPHS = {
  // ── Tab bar ──────────────────────────────────────────────
  home: `<path d="M4.5 11.2 C7 8.4 9.5 6.4 12 6.4 C14.5 6.4 17 8.4 19.5 11.2" />
...
<path d="M12 6.4 C12 5.2 12.6 4.4 13.6 3.9" />`,
  birthplan: `<path d="M6.5 4.6 C9.8 4.2 13.6 4.3 17.4 4.6 C18 4.6 18.5 5.1 18.5 5.8 L18.5 19 C18.5 19.6 18 20.1 17.4 20.1 C13.8 20.4 9.9 20.4 6.5 20.1 C5.9 20.1 5.4 19.6 5.4 19 L5.4 5.8 C5.4 5.1 5.9 4.6 6.5 4.6 Z" />
...
<path d="M14.6 15.2 C15.4 14.4 16.2 14.3 16.6 14.9 C16.9 15.4 16.5 16 15.7 16.6" />`,
  timer: `<circle cx="12" cy="13.4" r="7.2" />
<path d="M12 9.6 L12 13.4 L14.6 15.2" />
<path d="M9.8 3.6 L14.2 3.6" />
<path d="M12 3.6 L12 6.2" />`,
  team: `<path d="M9.2 11.4 C6.9 11.4 5.2 9.7 5.2 7.7 C5.2 5.8 6.9 4.3 9.2 4.3 C11.4 4.3 13.1 5.8 13.1 7.7 C13.1 9.7 11.4 11.4 9.2 11.4 Z" />
...
<path d="M16.6 14.2 C18.6 14.6 19.9 16.4 20.2 19.3" />`,
  messages: `<path d="M4.4 8.2 C4.4 6.3 5.9 4.8 7.8 4.8 L16.2 4.8 C18.1 4.8 19.6 6.3 19.6 8.2 L19.6 13.4 C19.6 15.3 18.1 16.8 16.2 16.8 L10.6 16.8 L6.6 19.8 L6.9 16.7 C5.4 16.3 4.4 15 4.4 13.4 Z" />
<path d="M8.4 9.4 C9.8 9.1 11.2 9.1 12.6 9.4" />
<path d="M8.4 12.2 C9.4 12 10.4 12 11.4 12.2" />`,
  profile: `<circle cx="12" cy="8.6" r="4.2" />
...
<path d="M12 19.6 C12.8 19.6 13.5 19.5 14.2 19.4" />`,
  ...
  about_me: `<circle cx="12" cy="8.4" r="3.9" />
<path d="M5.4 19.6 C6 16 8.5 14.2 12 14.2 C15.5 14.2 18 16 18.6 19.6" />
<path d="M9.9 8.2 C10.6 7.4 11.6 7 12.6 7.2" />`,
  labor_delivery: `<path d="M12 20 C8.4 16.4 5.6 13.2 5.6 9.8 C5.6 6.9 7.8 4.8 10.4 4.8 C11 4.8 11.6 5 12 5.3 C12.4 5 13 4.8 13.6 4.8 C16.2 4.8 18.4 6.9 18.4 9.8 C18.4 13.2 15.6 16.4 12 20 Z" />
<path d="M12 5.3 L12 9.4" />
<path d="M12 9.4 C13.8 9.4 15 10.4 15 12" />`,
  labor_support: `<path d="M8.4 19.2 L8.4 10.6 C8.4 9.9 8.9 9.4 9.6 9.4 L14.4 9.4 C15.1 9.4 15.6 9.9 15.6 10.6 L15.6 19.2" />
...
<path d="M12 9.4 C12 7.6 12.8 6.4 14.2 5.6" />`,
  pain_management: `<path d="M12 4.6 C10 6.8 9 9 9 11.4 C9 14.4 10.3 16.4 12 16.4 C13.7 16.4 15 14.4 15 11.4 C15 9 14 6.8 12 4.6 Z" />
<path d="M12 16.4 L12 19.4" />
<path d="M9.6 18 C11.2 18.6 12.8 18.6 14.4 18" />`,
  monitoring_iv: `<path d="M7.6 4.6 L7.6 8.4 C7.6 10.4 8.9 11.8 10.8 12 L10.8 19.4" />
...
<path d="M9.6 15.6 C11.2 16.4 12.8 16.4 14.4 15.6" />`,
  other_considerations: `<path d="M9 5.4 C11.4 5 13.9 5 16.9 5.4 C17.5 5.5 18 6 18 6.6 L18 18.2 C18 18.8 17.5 19.3 16.9 19.4 C13.9 19.8 11.4 19.8 9 19.4" />
...
<path d="M10.6 15.4 C11.6 15.3 12.4 15.3 13.4 15.4" />`,
  ...
  status_wip: `<path d="M12 4.4 C15.9 4.4 19.6 7.7 19.6 12 C19.6 16.3 15.9 19.6 12 19.6" />
<path d="M12 9.6 L12 13.4 L14.6 15.2" />`,
  status_done: `<circle cx="12" cy="12" r="7.6" />
<path d="M8.4 12.2 L10.8 14.6 L15.6 9.6" />`,

  // ── Utility ─────────────────────────────────────────────
  // Auto-share: sprig curling out of an open envelope-arc — "quiet automatic send"
  autoshare: `<path d="M4.8 10.6 L4.8 17.2 C4.8 18 5.4 18.6 6.2 18.6 L17.8 18.6 C18.6 18.6 19.2 18 19.2 17.2 L19.2 10.6" />
